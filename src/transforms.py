# Modified version of torchvision.transforms.functional with all dependencies for pytorch removed
# Useful for applying various transorms to a PIL image

# original source: https://github.com/pytorch/vision/blob/master/torchvision/transforms/functional.py
# original documentation: https://pytorch.org/docs/stable/torchvision/transforms.html#functional-transforms
    ...
    def parse_fill(fill, num_bands):
        if PILLOW_VERSION < "5.2.0":
            if fill is None:
                ...
                msg = (
                    "The option to fill background area of the rotated image, "
